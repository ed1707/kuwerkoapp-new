...
export default class CreateUnterbegriff extends Component {
  ...
  this.onChangeAndere_Wortarten = this.onChangeAndere_Wortarten.bind(this);
...
onChangeAndere_Wortarten(e) {
  this.setState({
    andere_wortarten: e.target.value
  })
}
...
onSubmit(e) {
  ...
  const unterbegriff = {
    ...
    andere_wortarten: this.state.andere_wortarten,
    ...
    return (
      ...
      <h3>Neuen Unterbegriff hinzufügen</h3>
        <form onSubmit={this.onSubmit}>
          ...
          <div className="form-group">
            <label>Andere Wortarten: </label>
            <input
                type="text"
                className="form-control"
                value={this.state.andere_wortarten}
                onChange={this.onChangeAndere_Wortarten}
                />
          </div>
